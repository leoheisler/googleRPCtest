...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Multiply = channel.unary_unary(
                ...
                _registered_method=True)
        self.Biggest = channel.unary_unary(
                '/Calculator/Biggest',
                request_serializer=calculator__pb2.BiggestRequest.SerializeToString,
                response_deserializer=calculator__pb2.BiggestReply.FromString,
                _registered_method=True)
...
class CalculatorServicer(object):
    ...
    def Biggest(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Biggest': grpc.unary_unary_rpc_method_handler(
                    servicer.Biggest,
                    request_deserializer=calculator__pb2.BiggestRequest.FromString,
                    response_serializer=calculator__pb2.BiggestReply.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def Biggest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Calculator/Biggest',
            calculator__pb2.BiggestRequest.SerializeToString,
            calculator__pb2.BiggestReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
